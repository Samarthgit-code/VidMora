...
DATABASES = {
    'default': dj_database_url.parse("postgresql://vidmora_f2z4_user:h8bM4VKzDixMJhnshbKt27av6dXmr6hD@dpg-d12sdqbipnbc73bbftsg-a.oregon-postgres.render.com/vidmora_f2z4")
}
